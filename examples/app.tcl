...
set init_script {
    ...
    package require tsession-valkey
    ...
    set valkeystore_config {
        host "localhost"
        port 6379
        password "foobared"
    }
    ::tsession::init [dict create store [list valkeystore $valkeystore_config] hmac_keyset $hmac_keyset save_uninitialized 0]
